      ...
      <div class="modal-content p-3">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input id="nuevoTipoNombre" class="form-control">
          </div>
          <div class="mb-3">
...
document.getElementById('guardarNuevoTipo').addEventListener('click', () => {
  ...
  fetch('guardarTipoEvento.php', {
    ...
    body: JSON.stringify({ nombre_tipo: nombre, requisitos: requisitos, nuevo_requisito: nuevoReq })
  })
  .then(res => res.json())
  .then(data => {
    if (data.success) {
